    ...
    <div class="Ajouter">
        ...
        <form action="" method="post">
            <div id="continaddroom">
                ...
                <div id="updatecontainer">
                    <h3> Superficie en m² : </h3> <input type="text" class="modifieroom"
                        placeholder="<?php echo $arrayMChambre[0]["Superficie"] ; ?>" name="Msuperficie">
                </div>
                <div id="updatecontainer">
                    <h3> Etage : </h3> <input type="text" class="modifieroom"
                        placeholder="<?php echo $arrayMChambre[0]["etageChambre"] ; ?>" name="Metage">
                </div>
                <div id="updatecontainer">
                    <h3> Nbr max locataire: </h3> <input type="text" class="modifieroom"
